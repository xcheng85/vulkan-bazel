...
list(APPEND _cmake_import_check_files_for_glslang::HLSL "${_IMPORT_PREFIX}/lib/libHLSL.a" )

# Import target "glslang::glslangtests" for configuration "Release"
set_property(TARGET glslang::glslangtests APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(glslang::glslangtests PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/glslangtests"
  )

list(APPEND _cmake_import_check_targets glslang::glslangtests )
list(APPEND _cmake_import_check_files_for_glslang::glslangtests "${_IMPORT_PREFIX}/bin/glslangtests" )
