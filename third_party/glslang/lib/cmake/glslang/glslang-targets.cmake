...
foreach(_cmake_expected_target IN ITEMS glslang::OSDependent glslang::glslang glslang::MachineIndependent glslang::GenericCodeGen glslang::glslang-default-resource-limits glslang::OGLCompiler glslang::glslang-standalone glslang::spirv-remap glslang::SPVRemapper glslang::SPIRV glslang::HLSL glslang::glslangtests)
...
# Create imported target glslang::OSDependent
...
# Create imported target glslang::glslang
add_library(glslang::glslang STATIC IMPORTED)

set_target_properties(glslang::glslang PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:glslang::OGLCompiler>;\$<LINK_ONLY:glslang::OSDependent>;\$<LINK_ONLY:glslang::MachineIndependent>"
)

# Create imported target glslang::MachineIndependent
add_library(glslang::MachineIndependent STATIC IMPORTED)

set_target_properties(glslang::MachineIndependent PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:glslang::OGLCompiler>;\$<LINK_ONLY:glslang::OSDependent>;\$<LINK_ONLY:glslang::GenericCodeGen>"
)

# Create imported target glslang::GenericCodeGen
add_library(glslang::GenericCodeGen STATIC IMPORTED)

# Create imported target glslang::glslang-default-resource-limits
...
# Create imported target glslang::OGLCompiler
...
set_target_properties(glslang::glslang-standalone PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/External"
)
...
add_library(glslang::SPVRemapper STATIC IMPORTED)
...
# Create imported target glslang::HLSL
add_library(glslang::HLSL STATIC IMPORTED)

# Create imported target glslang::glslangtests
add_executable(glslang::glslangtests IMPORTED)
